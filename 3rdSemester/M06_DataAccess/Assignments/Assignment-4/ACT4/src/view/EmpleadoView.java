...
public class EmpleadoView {
    ...
    private static void modificarEmpleado() {
        ...
        try {
            ...
            Empleado empleado = new Empleado(
                    ...
                    empleadoExistente.getContrasena(),
                    nombreCompleto,
                    telefono,
                    correo,
                    puesto
            ...
            System.out.println("Empleado " + empleado.getNombreCompleto() + " modificado correctamente.");
    ...
    private static void cambiarContrasena() {
        ...
        try {
            ...
            System.out.println("Error: No se pudo cambiar la contraseña. Motivo: " + e.getMessage());
        }
    }
